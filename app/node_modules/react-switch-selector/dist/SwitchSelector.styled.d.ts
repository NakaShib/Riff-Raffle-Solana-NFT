...
export declare const OptionInput: import("goober").StyledVNode<Omit<import("react").ClassAttributes<HTMLInputElement> & import("react").InputHTMLAttributes<HTMLInputElement> & import("goober").DefaultTheme, never>>;
export {};
