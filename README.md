...
1. **Update program address in the codebase**
   ...
   - Make sure to update the contract's `declare_id!("<address>")` to the `program-keypair.json` address. I also recommend searching for `raFZKVmR1KKgq4u6agEpfv9iyA5TWSrevrabLmo7eJL` in VSCode and doing replace-all with the new value.
...
--bpf-program raFZKVmR1KKgq4u6agEpfv9iyA5TWSrevrabLmo7eJL target/deploy/draffle.so \
